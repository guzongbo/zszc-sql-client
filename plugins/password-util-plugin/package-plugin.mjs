...
const pluginId = 'internal.password-util'
const pluginName = '密码工具'
const pluginVersion = '1.0.0'
const backendBinaryName = 'password-util-plugin'
...
const packagePath = path.join(outputDir, 'password-util-plugin.zszc-plugin')
...
for (const [platform, config] of Object.entries(platformConfig)) {
  ...
  await writePackageFile(
    path.join(stagingDir, relativeTargetPath),
    fileBuffer,
  )
}
